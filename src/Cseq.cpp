...
bool Cseq::Convert()
{
	...
	for (auto i = commands.begin(); i != commands.end(); ++i)
	{
		...
		if (!i->second.Extended)
		{
			...
			{
				smfInsertEvent(smf, absTime, track, track, SMF_EVENT_NEW_FROM_BYTES(0xFF, 0x06, 0x09, 0x4c, 0x6f, 0x6f, 0x70, 0x53, 0x74, 0x61, 0x72, 0x74);
			}
			...
			{
				smfInsertEvent(smf, absTime, track, track, SMF_EVENT_NEW_FROM_BYTES(0xFF, 0x06, 0x07, 0x4c, 0x6f, 0x6f, 0x70, 0x45, 0x6e, 0x64);
			}
